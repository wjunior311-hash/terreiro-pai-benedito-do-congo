...
export function OrixaIcon({name,size=54,className=''}){
 ...
 if(n==='exu')return <svg {...p}><circle cx="50" cy="50" r="47"/><path d="M50 8v84M28 28h44M38 16l-10 12M62 16l10 12" fill="none" stroke="#A52A24" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/><path d="M31 38q-10 12 0 24M69 38q10 12 0 24" fill="none" stroke="#A52A24" strokeWidth="3" strokeLinecap="round"/><circle cx="50" cy="91" r="3" fill="#A52A24"/></svg>
